...
//keyword
 //used with getDevices
        ...
        public unsafe struct mir_sdr_DeviceTwo
        {
            ...
            public mir_sdr_DeviceTwo(byte[] p1, byte[] p2, byte p3, byte p4)
            {
                SerNo = p1;
                DevNm = p2;
                hwVer = p3;
...
//keyword 
 //mir_sdr_GetDevices
        [DllImport("C:\\Program Files\\SDRplay\\API\\x86\\mir_sdr_api.dll")]
        private unsafe static extern mir_sdr_ErrT mir_sdr_GetDevices(mir_sdr_DeviceTwo[] devices, ref uint numDevs, uint maxDevs);
 ...
 //mir_sdr_Downconvert
        ...
        static unsafe void Main(string[] args)
        {
            ...
            mir_sdr_DeviceTwo[] ourDevices;                                               //array of Device structs (look at mir_sdr_DeviceT above)
            ourDevices = new mir_sdr_DeviceTwo[numberOfSDRs];                             //expect correct # of devices from what we told it.
            ...
            Console.WriteLine(ourDevices[z].SerNo[0]);
